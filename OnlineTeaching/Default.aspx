...
<body>
	...
	<div class="ws_images">
<a href="#"><img src="data1/images/7.jpg" alt="" title="" id="wows0" onclick="return wows0_onclick()" /></a>
...
<a style="display:none" href="http://wowslider.com">Script Image Slider by WOWSlider.com v1.7</a>
    ...
    <div id="logoo">
        <table width="100%">
            <tr>
                <td class="log">
                   <marquee BEHAVIOR=ALTERNATE><span class="logs"> ...Online Teaching...</span></marquee></td>
            </tr>
        </table>
    </div>
    <div id="footer" 
        style="color: #FFFFFF; text-align: center; vertical-align: middle;">All Copy Rights @drashti devani</div>
    </form>
</body>
</html>
